...
### ⚠️ Важно для Astra Linux 1.7

Полное обновление пакетов (`apt-get upgrade`) отключено по умолчанию в Astra Linux для безопасности (уровень "Орёл"). Это нормально - скрипты обрабатывают эту ошибку автоматически.
...
**Если вы видите ошибку про `apt-get upgrade`** - это нормально, скрипты продолжат работу без полного обновления пакетов.
